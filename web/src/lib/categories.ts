...
const CATEGORIES: Record<string, CategoryMeta> = {
  ...
  'shopping:online': { label: 'Online-Shopping', color: '#DC2626', background: 'rgba(220,38,38,0.12)' },
  ...
  'transport:public': { label: 'ÖPNV & Bahn', color: '#0EA5E9', background: 'rgba(14,165,233,0.12)' },
  'transport:rideshare': { label: 'Ridehail & Taxi', color: '#0EA5E9', background: 'rgba(14,165,233,0.12)' },
  subscriptions: { label: 'Abos & Mitgliedschaften', color: '#DB2777', background: 'rgba(219,39,119,0.12)' },
  'subscriptions:streaming': { label: 'Streamingdienste', color: '#DB2777', background: 'rgba(219,39,119,0.12)' },
  ...
  'housing:rent': { label: 'Miete & Wohnen', color: '#7C3AED', background: 'rgba(124,58,237,0.12)' },
  'housing:utilities': { label: 'Versorger & Nebenkosten', color: '#22D3EE', background: 'rgba(34,211,238,0.12)' },
