  ...
  return (
    <section className="rounded-2xl border border-slate-200/80 bg-white/60 p-6 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/60">
      ...
      <div className="space-y-4">
        ...
        {error ? (
          <div
            className="rounded-md border border-rose-200 bg-rose-50 px-3 py-2 text-xs text-rose-700 dark:border-rose-500/40 dark:bg-rose-500/10 dark:text-rose-200"
            role="alert"
          >
            {error}
          </div>
        ...
        <div
          className="rounded-lg border border-slate-200/70 bg-slate-50/80 px-4 py-3 text-sm text-slate-600 dark:border-slate-700 dark:bg-slate-900/60 dark:text-slate-300"
          aria-live="polite"
        >
          {result ? (
            <>
